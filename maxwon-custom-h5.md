...
![app 导航](https://raw.githubusercontent.com/huangciyin/notes/master/Web/maxwon/images/entry.jpg =300x)
...
这些信息包括: maxleap_appid,maxleap_apikey, maxleap_userid, maxleap_sessiontoken 的信息(key值不区分大小写.如果用户没有在 App 中登录, maxleap_userid, maxleap_sessiontoken为空,此时可以在 h5 中引导用户登录).  
